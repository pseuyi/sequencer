			...
			<div>
			{
				...
				<div id='splash-modal' onClick={this.toggle}>
					...
					<div id="info-div">
						...
						<p id="description3" >Click <svg fill="rgba(86, 101, 115, 0.7)" height="40" viewBox="0 0 24 24" width="40" xmlns="http://www.w3.org/2000/svg" onClick={this.props.toggleSplashPage}>
