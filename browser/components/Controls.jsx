	...
	render () {
		...
		<div>
			...
			<div id='controls' onMouseMove={this.hideShadow}>
				...
				{/* instructions button */}
				<svg fill="rgba(86, 101, 115, 0.7)" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg" onClick={this.props.savePage || this.props.patternPage? null: this.props.toggleInstructionsPage}>
					<path d="M0 0h24v24H0z" fill="none"/>
